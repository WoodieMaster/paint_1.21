execute as @e[type=armor_stand,tag=radio,tag=!setup] run data merge entity @s {NoBasePlate:1b,Pose:{}}
execute as @e[type=armor_stand,tag=screen,tag=!setup] run data merge entity @s {NoBasePlate:1b,Pose:{}}
execute as @e[type=armor_stand,tag=cake,tag=!setup] run data merge entity @s {NoBasePlate:1b,Pose:{}}
