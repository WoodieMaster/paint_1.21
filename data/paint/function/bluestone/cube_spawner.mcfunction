...
execute as @r at @s as @e[sort=nearest,limit=1,type=armor_stand,tag=spawnerA] at @s unless entity @e[scores={color=1}] align xyz run summon shulker ~0.5 ~ ~0.5 {Tags:["cube","cubesetup","cubeA"],NoGravity:1b,Invulnerable:0,PersistenceRequired:1,NoAI:1,Silent:1,Team:"knockback",Passengers:[{id:"armor_stand",Tags:["cubesetup","cubeA","cube","cubestand"],NoGravity:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:iron_hoe",Count:1}]}]}

execute as @r at @s as @e[sort=nearest,limit=1,type=armor_stand,tag=spawnerB] at @s unless entity @e[scores={color=2}] align xyz run summon shulker ~0.5 ~ ~0.5 {Tags:["cube","cubesetup","cubeB"],NoGravity:1b,Invulnerable:0,PersistenceRequired:1,NoAI:1,Silent:1,Team:"knockback",Passengers:[{id:"armor_stand",Tags:["cubesetup","cubeB","cube","cubestand"],NoGravity:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1}]}]}

execute as @r at @s as @e[sort=nearest,limit=1,type=armor_stand,tag=spawnerC] at @s unless entity @e[scores={color=3}] align xyz run summon shulker ~0.5 ~ ~0.5 {Tags:["cube","cubesetup","cubeC"],NoGravity:1b,Invulnerable:0,PersistenceRequired:1,NoAI:1,Silent:1,Team:"knockback",Passengers:[{id:"armor_stand",Tags:["cubesetup","cubeC","cube","cubestand"],NoGravity:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:golden_hoe",Count:1}]}]}

execute as @r at @s as @e[sort=nearest,limit=1,type=armor_stand,tag=spawnerD] at @s unless entity @e[scores={color=4}] align xyz run summon shulker ~0.5 ~ ~0.5 {Tags:["cube","cubesetup","cubeD"],NoGravity:1b,Invulnerable:0,PersistenceRequired:1,NoAI:1,Silent:1,Team:"knockback",Passengers:[{id:"armor_stand",Tags:["cubesetup","cubeD","cube","cubestand"],NoGravity:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:stone_hoe",Count:1}]}]}

execute as @r at @s as @e[sort=nearest,limit=1,type=armor_stand,tag=spawnerE] at @s unless entity @e[scores={color=5}] align xyz run summon shulker ~0.5 ~ ~0.5 {Tags:["cube","cubesetup","cubeE"],NoGravity:1b,Invulnerable:0,PersistenceRequired:1,NoAI:1,Silent:1,Team:"knockback",Passengers:[{id:"armor_stand",Tags:["cubesetup","cubeE","cube","cubestand"],NoGravity:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:wooden_hoe",Count:1}]}]}
...
execute as @e[tag=cube_spawner,tag=spawnerE] at @s positioned ~ ~0.5 ~ run particle minecraft:dust{color:[.8f,0f,1f],scale:.5} ~ ~ ~ 0.25 0.25 0.25 1 3