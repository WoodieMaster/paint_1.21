...
execute as @e[type=shulker,tag=cube] at @s if block ~1 ~ ~ polished_andesite unless entity @e[tag=valve_cube,distance=..2.5] align xyz run summon armor_stand ~1.5 ~.5 ~.5 {Tags:["valve","valve_cube","input"],NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:golden_axe",Count:1}]}
execute as @e[type=shulker,tag=cube] at @s if block ~-1 ~ ~ polished_andesite unless entity @e[tag=valve_cube,distance=..2.5] align xyz run summon armor_stand ~-.5 ~.5 ~.5 {Tags:["valve","valve_cube","input"],NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:golden_axe",Count:1}]}
execute as @e[type=shulker,tag=cube] at @s if block ~ ~ ~1 polished_andesite unless entity @e[tag=valve_cube,distance=..2.5] align xyz run summon armor_stand ~.5 ~.5 ~1.5 {Tags:["valve","valve_cube","input"],NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:golden_axe",Count:1}]}
execute as @e[type=shulker,tag=cube] at @s if block ~ ~ ~-1 polished_andesite unless entity @e[tag=valve_cube,distance=..2.5] align xyz run summon armor_stand ~.5 ~.5 ~-.5 {Tags:["valve","valve_cube","input"],NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:golden_axe",Count:1}]}
execute as @e[type=shulker,tag=cube] at @s if block ~ ~1 ~ polished_andesite unless entity @e[tag=valve_cube,distance=..2.5] align xyz run summon armor_stand ~.5 ~1.5 ~.5 {Tags:["valve","valve_cube","input"],NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:golden_axe",Count:1}]}
execute as @e[type=shulker,tag=cube] at @s if block ~ ~-1 ~ polished_andesite unless entity @e[tag=valve_cube,distance=..2.5] align xyz run summon armor_stand ~.5 ~-.5 ~.5 {Tags:["valve","valve_cube","input"],NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,ArmorItems:[{},{},{},{id:"minecraft:golden_axe",Count:1}]}
